...
<head>
  ...
  <!-- Load File Jquery -->
  <script src="<?php echo base_url("assets/jquery-3.5.1.min.js"); ?>" type="text/javascript"></script>
</head>
<body>
  <h1>Form Tambah Siswa</h1>
  
  <form method="post" action="<?php echo base_url("multiple/save"); ?>">
